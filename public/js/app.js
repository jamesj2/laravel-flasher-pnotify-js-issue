...
/***/ "./node_modules/@flasher/flasher-pnotify/dist/flasher-pnotify.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@flasher/flasher-pnotify/dist/flasher-pnotify.js ***!
  \***********************************************************************/
...
(function (global, factory) {
     true ? module.exports = factory(__webpack_require__(/*! @flasher/flasher */ "./node_modules/@flasher/flasher/dist/flasher.js")) :
    0;
    ...
    ***************************************************************************** */
    ...
    var PnotifyFactory = /** @class */ (function () {
        ...
        PnotifyFactory.prototype.renderOptions = function (options) {
            this.updateDefaultOptions(PNotify.defaults, options);
        };
        return PnotifyFactory;
    }());
    var flasher = Flasher__default['default'].getInstance();
...
/***/ "./node_modules/@flasher/flasher-sweet-alert/dist/flasher-sweet-alert.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@flasher/flasher-sweet-alert/dist/flasher-sweet-alert.js ***!
  \*******************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
`.replace(/(^|\n)\s*/g, '');
    ...
    var SweetAlertFactory = /** @class */ (function () {
        ...
        SweetAlertFactory.prototype.render = function (envelope) {
            ...
            return (_a = this.swalToastr) === null || _a === void 0 ? void 0 : _a.fire(options);
        };
        SweetAlertFactory.prototype.renderOptions = function (options) {
            this.swalToastr = this.swalToastr || Swal.mixin(options);
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.render(this.queue[i])];
                        case 2:
                            // eslint-disable-next-line no-await-in-loop
                            _a.sent();
                            _a.label = 3;
...
/***/ "./node_modules/@flasher/flasher/dist/flasher.js":
/*!*******************************************************!*\
  !*** ./node_modules/@flasher/flasher/dist/flasher.js ***!
  \*******************************************************/
/***/ (function(module) {
...
(function (global, factory) {
  ...
  var Flasher = /** @class */ (function () {
      ...
      Flasher.prototype.render = function (response) {
          ...
          this.addStyles(response.styles, function () {
              _this.addScripts(response.scripts, function () {
                  ...
                  _this.renderEnvelopes(response.envelopes);
              });
          });
      };
      ...
      Flasher.prototype.renderEnvelopes = function (envelopes) {
          var _this = this;
          var queues = new Map();
  ...
  var TemplateFactory = /** @class */ (function () {
      ...
      TemplateFactory.prototype.render = function (envelope) {
          ...
          if (undefined !== notification.options && undefined !== notification.options.position) {
              this.options.position = notification.options.position;
          }
          var container = document.getElementById("flasher-container-" + this.options.position);
          if (container === null) {
          ...
          if (progressBar instanceof HTMLElement) {
              var width_1 = 0;
              var progress_1;
              var lapse_1 = 1000 / this.options.fps;
              var showProgress_1 = function () {
                  width_1 += 1;
                  var percent = (1 - lapse_1 * (width_1 / _this.options.timeout)) * 100;
...
/* harmony import */ var _flasher_flasher_pnotify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @flasher/flasher-pnotify */ "./node_modules/@flasher/flasher-pnotify/dist/flasher-pnotify.js");
...
/* harmony import */ var _flasher_flasher_sweet_alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @flasher/flasher-sweet-alert */ "./node_modules/@flasher/flasher-sweet-alert/dist/flasher-sweet-alert.js");
/* harmony import */ var _flasher_flasher_sweet_alert__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_flasher_flasher_sweet_alert__WEBPACK_IMPORTED_MODULE_1__);
window.Flasher = __webpack_require__(/*! @flasher/flasher */ "./node_modules/@flasher/flasher/dist/flasher.js");
